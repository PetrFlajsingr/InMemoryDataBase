...
ZakladniUdaje::ZakladniUdaje(const pt::ptree &ptree) {
  auto zaklUdaje = ptree.get_child("are:Ares_odpovedi")
                       .get_child("are:Odpoved")
                       .get_child("are:Vypis_VREO")
                       .get_child("are:Zakladni_udaje");

  try {
    ICO = zaklUdaje.get_child("are:ICO").get_value<std::string>();
  } catch (...) {
  }
  try {
    ObchodniFirma = zaklUdaje.get_child("are:ObchodniFirma").get_value<std::string>();
  } catch (...) {
  }
  try {
    Kod_PF = zaklUdaje.get_child("are:Kod_PF").get_value<std::string>();
  } catch (...) {
  }
  try {
    Nazev_PF = zaklUdaje.get_child("are:Nazev_PF").get_value<std::string>();
  } catch (...) {
  }
  try {
  ...
  try {
    sidlo_psc = zaklUdaje.get_child("are:Sidlo").get_child("are:psc").get_value<std::string>();
  } catch (...) {
  }
  try {
  ...
  try {
    sidlo_mop = zaklUdaje.get_child("are:Sidlo").get_child("are:mop").get_value<std::string>();
  } catch (...) {
  }
  try {
  ...
  try {
    sidlo_doplnujiciText = zaklUdaje.get_child("are:Sidlo").get_child("are:doplnujiciText").get_value<std::string>();
  } catch (...) {
  }
  try {
    sidlo_dorucovaciCislo = zaklUdaje.get_child("are:Sidlo").get_child("are:dorucovaciCislo").get_value<std::string>();
  } catch (...) {
  }
  try {
    sidlo_skrytyUdaj =
  ...
  try {
    bydliste_ruianKod = zaklUdaje.get_child("are:Bydliste").get_child("are:ruianKod").get_value<std::string>();
  } catch (...) {
  }
  try {
  ...
  try {
    bydliste_castObce = zaklUdaje.get_child("are:Bydliste").get_child("are:castObce").get_value<std::string>();
  } catch (...) {
  }
  try {
  ...
  try {
    bydliste_cisloPop = zaklUdaje.get_child("are:Bydliste").get_child("are:cisloPop").get_value<std::string>();
  } catch (...) {
  }
  try {
  ...
  try {
    bydliste_cisloTxt = zaklUdaje.get_child("are:Bydliste").get_child("are:cisloTxt").get_value<std::string>();
  } catch (...) {
  }
  try {
  ...
  try {
    pobyt_psc = zaklUdaje.get_child("are:Pobyt").get_child("are:psc").get_value<std::string>();
  } catch (...) {
  }
  try {
  ...
  try {
    pobyt_mop = zaklUdaje.get_child("are:Pobyt").get_child("are:mop").get_value<std::string>();
  } catch (...) {
  }
  try {
  ...
  try {
    pobyt_doplnujiciText = zaklUdaje.get_child("are:Pobyt").get_child("are:doplnujiciText").get_value<std::string>();
  } catch (...) {
  }
  try {
    pobyt_dorucovaciCislo = zaklUdaje.get_child("are:Pobyt").get_child("are:dorucovaciCislo").get_value<std::string>();
  } catch (...) {
  }
  try {
    pobyt_skrytyUdaj =
  ...
  try {
    DatumVzniku = zaklUdaje.get_child("are:DatumVzniku").get_value<std::string>();
  } catch (...) {
  }
  try {
    DatumZapisu = zaklUdaje.get_child("are:DatumZapisu").get_value<std::string>();
  } catch (...) {
  }
  try {
    DatumVymazu = zaklUdaje.get_child("are:DatumVymazu").get_value<std::string>();
  } catch (...) {
  }
  try {
    DuvodVymazu = zaklUdaje.get_child("are:DuvodVymazu").get_value<std::string>();
  } catch (...) {
  }
  try {
  ...
  try {
    PredmetPodnikani = zaklUdaje.get_child("are:Cinnosti")
                           .get_child("are:PredmetPodnikani")
                           .get_child("are:Text")
                           .get_value<std::string>();
  } catch (...) {
  }
  try {
    DoplnkovaCinnost = zaklUdaje.get_child("are:Cinnosti")
                           .get_child("are:DoplnkovaCinnost")
                           .get_child("are:Text")
                           .get_value<std::string>();
  } catch (...) {
  }
  try {
    PredmetCinnosti = zaklUdaje.get_child("are:Cinnosti")
                          .get_child("are:PredmetCinnosti")
                          .get_child("are:Text")
                          .get_value<std::string>();
  } catch (...) {
  }
  try {
    Ucel = zaklUdaje.get_child("are:Cinnosti").get_child("are:Ucel").get_child("are:Text").get_value<std::string>();
  } catch (...) {
  }
}
