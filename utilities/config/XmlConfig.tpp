...
template <typename T>
bool setByName(tinyxml2::XMLDocument *doc, tinyxml2::XMLElement *el, const T &value, const KeysContainer &keys,
...
bool ConfigContainerTraits<XmlContainer>::contains(XmlContainer &container, const Keys &... keys) {
  KeysContainer tmpKeys{keys...};
  auto element = container->RootElement();
...
void ConfigSaver<XmlContainer>::save(XmlContainer &config, std::string_view path) {
