...
template <typename T, int N> struct _swizzle_base0 {
protected:
...
protected:
  template <typename U> GLM_FUNC_QUALIFIER void _apply_op(vec<N, T, Q> const &that, const U &op) {
...
#define GLM_SWIZZLE_TEMPLATE2                                                                                          \
  template <int N, typename T, qualifier Q, int E0, int E1, int E2, int E3, int F0, int F1, int F2, int F3>
...
#define GLM_SWIZZLE_SCALAR_BINARY_OPERATOR_IMPLEMENTATION(OPERAND)                                                     \
  GLM_SWIZZLE_TEMPLATE1                                                                                                \
  GLM_FUNC_QUALIFIER vec<N, T, Q> operator OPERAND(const GLM_SWIZZLE_TYPE1 &a, const T &b) { return a() OPERAND b; }   \
  GLM_SWIZZLE_TEMPLATE1                                                                                                \
  GLM_FUNC_QUALIFIER vec<N, T, Q> operator OPERAND(const T &a, const GLM_SWIZZLE_TYPE1 &b) { return a OPERAND b(); }
...
#define GLM_SWIZZLE_FUNCTION_2_ARGS_SCALAR(RETURN_TYPE, FUNCTION)                                                      \
  GLM_SWIZZLE_TEMPLATE2                                                                                                \
  GLM_FUNC_QUALIFIER typename GLM_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(const GLM_SWIZZLE_TYPE1 &a,                      \
                                                                      const GLM_SWIZZLE_TYPE2 &b, const T &c) {        \
    return FUNCTION(a(), b(), c);                                                                                      \
  }                                                                                                                    \
  GLM_SWIZZLE_TEMPLATE1                                                                                                \
  GLM_FUNC_QUALIFIER typename GLM_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(const GLM_SWIZZLE_TYPE1 &a,                      \
                                                                      const GLM_SWIZZLE_TYPE1 &b, const T &c) {        \
    return FUNCTION(a(), b(), c);                                                                                      \
  }                                                                                                                    \
  GLM_SWIZZLE_TEMPLATE1                                                                                                \
  GLM_FUNC_QUALIFIER typename GLM_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(const GLM_SWIZZLE_TYPE1 &a,                      \
                                                                      const typename S0::vec_type &b, const T &c) {    \
    return FUNCTION(a(), b, c);                                                                                        \
  }                                                                                                                    \
  GLM_SWIZZLE_TEMPLATE1                                                                                                \
  GLM_FUNC_QUALIFIER typename GLM_SWIZZLE_TYPE1::RETURN_TYPE FUNCTION(const typename V &a, const GLM_SWIZZLE_TYPE1 &b, \
                                                                      const T &c) {                                    \
    return FUNCTION(a, b(), c);                                                                                        \
  }
