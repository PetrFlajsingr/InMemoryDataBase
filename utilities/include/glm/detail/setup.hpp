...
// User defines: GLM_FORCE_CXX98, GLM_FORCE_CXX03, GLM_FORCE_CXX11,
// GLM_FORCE_CXX14, GLM_FORCE_CXX17, GLM_FORCE_CXX2A
...
// Android has multiple STLs but C++11 STL detection doesn't always work #284
// #564
...
#define GLM_HAS_STATIC_ASSERT                                                                                          \
  ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_CUDA)) || ((GLM_COMPILER & GLM_COMPILER_VC))))
#endif
...
#define GLM_HAS_UNRESTRICTED_UNIONS                                                                                    \
  (GLM_LANG & GLM_LANG_CXX0X_FLAG) && ((GLM_COMPILER & GLM_COMPILER_VC) || ((GLM_COMPILER & GLM_COMPILER_CUDA)))
#endif
...
#define GLM_HAS_TEMPLATE_ALIASES                                                                                       \
  ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_INTEL)) ||                                       \
                                        ((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC12)) ||   \
                                        ((GLM_COMPILER & GLM_COMPILER_CUDA))))
#endif
...
#define GLM_HAS_RANGE_FOR                                                                                              \
  ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_INTEL)) || ((GLM_COMPILER & GLM_COMPILER_VC)) || \
                                        ((GLM_COMPILER & GLM_COMPILER_CUDA))))
#endif
...
// http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2007/n2235.pdf N3652
...
#define GLM_HAS_ASSIGNABLE                                                                                             \
  ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC15)) ||   \
...
namespace glm {
template <typename T, std::size_t N> constexpr std::size_t countof(T const (&)[N]) { return N; }
} // namespace glm
...
template <> struct is_int<signed int> {
  enum test { value = ~0 };
};
} // namespace detail
...
namespace glm {
namespace detail {
template <typename genType> struct make_unsigned {};
...
template <> struct make_unsigned<int64> { typedef uint64 type; };
...
template <> struct make_unsigned<uint64> { typedef uint64 type; };
} // namespace detail
} // namespace glm
#endif
