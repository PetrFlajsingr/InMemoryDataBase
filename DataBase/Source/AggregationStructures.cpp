...
void DataBase::Min::reset() {
  switch (field->getFieldType()) {
    case ValueType::Integer:min._integer = std::numeric_limits<int>::min();
      break;
    case ValueType::Double:min._double = std::numeric_limits<double>::lowest();
      break;
...
void DataBase::Max::reset() {
  switch (field->getFieldType()) {
    case ValueType::Integer:max._integer = std::numeric_limits<int>::max();
      break;
    case ValueType::Double:max._double = std::numeric_limits<double>::max();
      break;
...
DataContainer DataBase::Avg::getResult() {
  ...
  switch (Sum::field->getFieldType()) {
    case ValueType::Integer:result._double = Sum::sum._integer / (double) Count::count;
      break;
    case ValueType::Double:result._double = Sum::sum._double / Count::count;
      break;
