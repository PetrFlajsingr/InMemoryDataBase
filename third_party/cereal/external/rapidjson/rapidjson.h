...
#define CEREAL_RAPIDJSON_VERSION_STRING                                                                                \
  CEREAL_RAPIDJSON_STRINGIFY(                                                                                          \
      CEREAL_RAPIDJSON_MAJOR_VERSION.CEREAL_RAPIDJSON_MINOR_VERSION.CEREAL_RAPIDJSON_PATCH_VERSION)
...
#define CEREAL_RAPIDJSON_SETPOINTER(type, p, x)                                                                        \
  (p = reinterpret_cast<type *>(                                                                                       \
       (reinterpret_cast<uintptr_t>(p) & static_cast<uintptr_t>(CEREAL_RAPIDJSON_UINT64_C2(0xFFFF0000, 0x00000000))) | \
...
#define CEREAL_RAPIDJSON_GETPOINTER(type, p)                                                                           \
  (reinterpret_cast<type *>(reinterpret_cast<uintptr_t>(p) &                                                           \
                            static_cast<uintptr_t>(CEREAL_RAPIDJSON_UINT64_C2(0x0000FFFF, 0xFFFFFFFF))))
#else
...
#define CEREAL_RAPIDJSON_STATIC_ASSERT(x)                                                                              \
  typedef ::CEREAL_RAPIDJSON_NAMESPACE::StaticAssertTest<sizeof(                                                       \
      ::CEREAL_RAPIDJSON_NAMESPACE::STATIC_ASSERTION_FAILURE<bool(x)>)>                                                \
...
// adopted from Boost
#define CEREAL_RAPIDJSON_VERSION_CODE(x, y, z) (((x)*100000) + ((y)*100) + (z))

///////////////////////////////////////////////////////////////////////////////
// CEREAL_RAPIDJSON_DIAG_PUSH/POP, CEREAL_RAPIDJSON_DIAG_OFF

#if defined(__GNUC__)
#define CEREAL_RAPIDJSON_GNUC CEREAL_RAPIDJSON_VERSION_CODE(__GNUC__, __GNUC_MINOR__, __GNUC_PATCHLEVEL__)
#endif

#if defined(__clang__) ||                                                                                              \
    (defined(CEREAL_RAPIDJSON_GNUC) && CEREAL_RAPIDJSON_GNUC >= CEREAL_RAPIDJSON_VERSION_CODE(4, 2, 0))
...
#if defined(__clang__) ||                                                                                              \
    (defined(CEREAL_RAPIDJSON_GNUC) && CEREAL_RAPIDJSON_GNUC >= CEREAL_RAPIDJSON_VERSION_CODE(4, 6, 0))
...
#endif
#elif (defined(CEREAL_RAPIDJSON_GNUC) && (CEREAL_RAPIDJSON_GNUC >= CEREAL_RAPIDJSON_VERSION_CODE(4, 3, 0)) &&          \
...
#elif (defined(CEREAL_RAPIDJSON_GNUC) && (CEREAL_RAPIDJSON_GNUC >= CEREAL_RAPIDJSON_VERSION_CODE(4, 6, 0)) &&          \
       defined(__GXX_EXPERIMENTAL_CXX0X__))
