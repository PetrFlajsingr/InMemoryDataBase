...
public:
  ...
  */
  ...
  void *Malloc(size_t size) {
    ...
    void *buffer =
        reinterpret_cast<char *>(chunkHead_) + CEREAL_RAPIDJSON_ALIGN(sizeof(ChunkHeader)) + chunkHead_->size;
  ...
  void *Realloc(void *originalPtr, size_t originalSize, size_t newSize) {
    ...
    if (originalPtr == reinterpret_cast<char *>(chunkHead_) + CEREAL_RAPIDJSON_ALIGN(sizeof(ChunkHeader)) +
  ...
  */
  bool AddChunk(size_t capacity) {
    ...
    if (ChunkHeader *chunk = reinterpret_cast<ChunkHeader *>(
            baseAllocator_->Malloc(CEREAL_RAPIDJSON_ALIGN(sizeof(ChunkHeader)) + capacity))) {
