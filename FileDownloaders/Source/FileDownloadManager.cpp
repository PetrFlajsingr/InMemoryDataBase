...
void FileDownloadManager::unfinished() { unfinishedFileCount++; }
void FileDownloadManager::finished() { unfinishedFileCount--; }

FileDownloadManager::CountObserver::CountObserver(FileDownloadManager *parent) : parent(parent) {}
void FileDownloadManager::CountObserver::onDownloadStarted(std::string_view) { parent->unfinished(); }
void FileDownloadManager::CountObserver::onDownloadFailed(std::string_view, std::string_view) { parent->finished(); }
void FileDownloadManager::CountObserver::onDownloadFinished(std::string_view, std::string_view) { parent->finished(); }
...
void FileDownloadManager::Dispatcher::onDownloadFailed(std::string_view fileName, std::string_view) {
  dispatch(new DownloadProgress(DownloadState::failed, std::string(fileName)));
}
void FileDownloadManager::Dispatcher::onDownloadFinished(std::string_view fileName, std::string_view) {
